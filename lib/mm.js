...
var MM = {
    ...
    loadCourses: function(courses) {
        ...
        // Prepare info for loading main menu. last point do check
    ...
    addSite: function(e) {
        ...
        window.plugins.PushbotsPlugin.updateAlias(username);
        MM.saveSite(username, password, siteurl);
    },
